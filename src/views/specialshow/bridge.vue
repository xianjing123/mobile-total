    ...
    return {
      ...
      option3:{
        ...
        series:[{
          ...
          center: ['50%', '30%'],
          avoidLabelOverlap: false,
          data:[{value:700, name:'电流异常'},{value:400,name:'运行数据异常'}],
          itemStyle:{ 
            normal:{
            label:{
              show:true,
  ...
  mounted:function(){
    ...
    this.$nextTick(function(){
      ...
      _this.axios.get(''+_this.url+'/way/bridge/mobileTerminalDisplay2?month='+_this.mounth+'').then(res => {     
            ...
            _this.shifts3 = (data["304桥洞"][1].value/data["304桥洞"][0].value)*100
            _this.report3 = (data["春晖桥洞"][1].value/data["春晖桥洞"][0].value)*100
    ...
    this.$nextTick(function(){
      ...
      _this.axios.get(''+_this.url+'/way/bridge/mobileTerminalDisplay1?month='+_this.mounth+'').then(res => {     
            ...
            _this.shifts1 = (data["振兴桥洞"][1].value/data["振兴桥洞"][0].value)*100
            _this.report1 = (data["舞阳桥洞"][1].value/data["舞阳桥洞"][0].value)*100
